...
* `ghcr.io/jehy/php-fpm-mediawiki_1.45:latest`
...
# run updates without entering docker container
docker exec serial-wiki-hermes-php php /var/www/public_html/maintenance/run.php update
```
