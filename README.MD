...
UPD: It appears that I was wrong, official mediawiki README lies about supported version, and I did not list all the tags. Now I see that there are images from 1.29+, so **you can possibly use those**. Anyway, if you wanna build new images then this repo and images may be useful.
